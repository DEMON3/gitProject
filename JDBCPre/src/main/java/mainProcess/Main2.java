...
//        if(conn==null) conn = DriverManager.getConnection ("jdbc:oracle:thin:@localhost:1521:wy","wy" , "1234");
//
//        return conn;
//    }
...
//        Connection conn = DriverManager.getConnection ("jdbc:oracle:thin:@localhost:1521:wy","wy" , "1234");
...
//            //2 得到所有的 genl 记录
//            {
//                String qSql = " Select * from Diabetes_Settle_genl_mon1  t   ";
//                //		"where t.billing_date >= to_date ('"+str+"','yyyy-mm-dd') and t.billing_date <= to_date ('"+end+"','yyyy-mm-dd') ";
...
//                double perc = relateCount/sumCount;
//                if(perc<0.001) zeroList.add(cur.getMedicareRegisterationID());
//                cur.setRelatePercent(perc);
//                List<Double> tempList = new ArrayList<>();
//                tempList.add((double)score);
//                tempList.add(cur.getRelatePercent());
//                relateScoreList.add(tempList);
//                if(count==0) count=1;
//                if(chineseCount/count>0){
//                    map.remove(curKey);
//                }else {
...
//                }
//            }
//            String basePath = "D:/A/gitProject/gitProject/JDBCPre/src/main/resources/";
//            generateJsonFile(new File(basePath+"label.json"),label);
//            generateJsonFile(new File(basePath+"zero.json"),zeroList);
